...
image: ../assets/sentry-decision-cover.png
info:
...
![Decision pipeline: VAE state encoding, sequence model, and subtree scoring head](/img/RM/decision_pipeline.png)
...
![Visibility-aware waypoint scoring on the arena map](/img/RM/VisibilityMap.png)
...
![Foxglove debug panel with injected match state](/img/RM/foxglove-panel.png)

![Keypoint annotation tool](/img/RM/point_choose.png)

![Region annotation tool](/img/RM/area_choose.png)
